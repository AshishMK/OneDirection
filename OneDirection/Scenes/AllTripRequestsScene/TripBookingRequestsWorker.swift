//
//  TripBookingRequestsWorker.swift
//  OneDirection
//
...
class TripBookingRequestsWorker
{
     func getMyTripRequests(completion: @escaping ([TripRequest], Error?) -> Void)
    {
        MainWorker.taskForGETRequest(url: MainWorker.Endpoints.getTripRequestOD.url, responseType: TripBookingRequests.Response.self){ (response,error)
            in
    ...
    func sendTicketrequest(body: TripBookingRequests.Request,completion: @escaping (Bool, String) -> Void)
    {
